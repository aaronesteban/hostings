					...
					<?php foreach ($facturas as $factura): ?>
						<tr class="informacion_factura">
							...
							<td class="actions">
								...
								<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $factura['Factura']['id']), array('class' => 'btn btn-xs btn-danger'), array('confirm' => __('Estás seguro que deseas eliminar esta factura?', $factura['Factura']['id']))); ?>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>
