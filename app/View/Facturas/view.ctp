<div class='row'>	
	<div class="actions col-md-2">
		...
		<ul>
			<li><?php echo $this->Html->link(__('Editar Factura'), array('action' => 'edit', $factura['Factura']['id']), array( 'class' => 'btn btn-primary')); ?> </li>
			<li><?php echo $this->Form->postLink(__('Eliminar Factura'), array('action' => 'delete', $factura['Factura']['id']), array( 'class' => 'btn btn-danger boton'), array(), __('Estás seguro que deseas eliminar esta factura?', $factura['Factura']['id'])); ?> </li>
		</ul>
	</div>
	<div class="facturas view col-md-9">
