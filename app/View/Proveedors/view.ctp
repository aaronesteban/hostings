<div class='row'>	
	<div class="actions col-md-2">
		...
		<ul>
			<li><?php echo $this->Html->link(__('Editar Proveedor'), array('action' => 'edit', $proveedor['Proveedor']['id']), array( 'class' => 'btn btn-primary')); ?> </li>
			<li><?php echo $this->Form->postLink(__('Eliminar Proveedor'), array('action' => 'delete', $proveedor['Proveedor']['id']), array( 'class' => 'btn btn-danger boton'), array(), __('Estás seguro que deseas eliminar a este proveedor?', $proveedor['Proveedor']['id'])); ?> </li>
		</ul>
	</div>
	<div class="proveedors view col-md-9">
