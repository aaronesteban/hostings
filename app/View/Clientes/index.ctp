<div class='row'>
	...
	<div class="clientes index col-md-9">
		...
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('Detalle'), array('action' => 'view', $cliente['Cliente']['id']), array('class' => 'btn btn-info')); ?>
				<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $cliente['Cliente']['id']), array('class' => 'btn btn-warning')); ?>
				<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $cliente['Cliente']['id']), array('class' => 'btn btn-danger'), array('confirm' => __('Estás seguro que deseas eliminar a este cliente?', $cliente['Cliente']['id']))); ?>
			</td>
		</tr>
	<?php endforeach; ?>
		</tbody>
