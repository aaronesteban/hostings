<div class='row'>
	<div class="actions col-md-2">
		...
		<ul>
			<li><?php echo $this->Html->link(__('Editar Cliente'), array('action' => 'edit', $cliente['Cliente']['id']), array( 'class' => 'btn btn-sm btn-primary')); ?> </li>
	...
	<div class="clientes view col-md-8 col-md-offset-2">
