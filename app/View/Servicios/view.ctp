<div class='row'>	
	<div class="actions col-md-2">
		...
		<ul>
			<li><?php echo $this->Html->link(__('Editar Servicio'), array('action' => 'edit', $servicio['Servicio']['id']), array( 'class' => 'btn btn-primary')); ?> </li>
			<li><?php echo $this->Form->postLink(__('Eliminar Servicio'), array('action' => 'delete', $servicio['Servicio']['id']),array( 'class' => 'btn btn-danger boton'), array(), __('Estás seguro que deseas eliminar este servicio?', $servicio['Servicio']['id'])); ?> </li>
		</ul>
	</div>
	<div class="servicios view col-md-9">
...
<div class="related">
	...
	<?php foreach ($servicio['Factura'] as $factura): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('Detalle'), array('controller' => 'facturas', 'action' => 'view', $factura['id']), array('class' => 'btn btn-info')); ?>
				<?php echo $this->Html->link(__('Editar'), array('controller' => 'facturas', 'action' => 'edit', $factura['id']), array('class' => 'btn btn-warning')); ?>
				<?php echo $this->Form->postLink(__('Eliminar'), array('controller' => 'facturas', 'action' => 'delete', $factura['id']), array('class' => 'btn btn-danger'), array(), __('Estás seguro que deseas eliminar esta factura?', $factura['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
