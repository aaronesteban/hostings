			...
			<table cellpadding="0" cellspacing="0" class='table'>
				...
				<tbody>
					...
					<tr class="informacion_proveedor">
						...
						<td><?php echo $this->Time->format('d-m-Y', $proveedor['Proveedor']['created']); ?>&nbsp;</td>
						<td><?php echo $this->Time->format('d-m-Y', $proveedor['Proveedor']['modified']); ?>&nbsp;</td>
						<td class="actions">
							...
							<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $proveedor['Proveedor']['id']), array('class' => 'btn btn-xs btn-danger', 'confirm' => __('Estás seguro que deseas eliminar a este proveedor?', $proveedor['Proveedor']['id']))); ?>
						</td>
					</tr>
					<?php endforeach; ?>
				</tbody>
