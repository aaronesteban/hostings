	...
	<h2><?php echo __('Proveedor'); ?></h2>
		<dl>
			...
			<div class="mb5">
				...
				<dd class="display_inline">
					<?php echo $this->Time->format('d-m-Y', $proveedor['Proveedor']['created']); ?>
					&nbsp;
				</dd>
			</div>
			<div class="mb5">
				...
				<dd class="display_inline">
					<?php echo $this->Time->format('d-m-Y', $proveedor['Proveedor']['modified']); ?>
					&nbsp;
				</dd>
			</div>
		</dl>
...
<div class="related">
	...
	<?php foreach ($proveedor['Servicio'] as $servicio): ?>
		<tr class="informacion_servicio">
			...
			<td><?php echo $this->Time->format('d-m-Y', $servicio['vencimiento']); ?></td>
