	...
	<h2><?php echo __('Factura'); ?></h2>
		<dl>
			...
			<div class="mb5">
				...
				<dd class="display_inline">
					<?php echo $this->Time->format('d-m-Y', $factura['Factura']['fecha']); ?>
					&nbsp;
				</dd>
			</div>
			<div class="mb5">
			...
			<div class="mb5">
				...
				<dd class="display_inline">
					<?php echo $this->Time->format('d-m-Y', $factura['Factura']['created']); ?>
					&nbsp;
				</dd>
			</div>
			<div class="mb5">
				...
				<dd class="display_inline">
					<?php echo $this->Time->format('d-m-Y', $factura['Factura']['modified']); ?>
					&nbsp;
				</dd>
			</div>
			<div class="mb5">
